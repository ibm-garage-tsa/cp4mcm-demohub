---
title: Lab 5 - Event Management and Runbook Automation - Skytap
description:
---
...
- You need to provision your own copy of the CP4MCM 2.1 environment, start it and verify for correct startup (check [here](../preparing/)).
