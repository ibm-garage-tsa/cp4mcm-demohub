---
title: Getting Started with Cloud Pak for MCM 2.0 demo environment
description: Getting Started with Cloud Pak for MCM 2.0 demo environment
---

***

This tutorial as well as other linked ones were designed to run using the following environment: [https://bluedemos.com/show/3915](https://bluedemos.com/show/3915)
...
## Opening Cloud Pak for MCM User Interface
  ...
  ![](images/2020-09-11-11-25-25.png)
  ...
  ![](images/2020-09-11-11-35-04.png)

  Monitor health

  ![](images/2020-09-11-11-35-55.png)

  If you cannot see these menus, check if there are any [hanging pods](#some-pods-hangs-on-startup). It is worth waiting another 3-5 minutes and refreshing the browser window. The environment is massive and it really takes a time to stabilize Kubernetes cluster with 500+ pods running after startup of VMs.

  If you see the menus, environment is ready to start the excercises. If you cannot see just Monitoring menus - don't worry, you can still do most of the labs.
