...
11.Click the **Cluster violations** link to find which cluster is violating the policy.
...
12.Open a new browser tab, and open the OpenShift Web Console (there is a link in the email that you received when you requested your Managed ROKS environment - Cloud Pak for **Apps**).
